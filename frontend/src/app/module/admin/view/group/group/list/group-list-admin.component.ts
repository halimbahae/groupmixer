...
@Component({
  selector: 'app-group-list-admin',
  templateUrl: './group-list-admin.component.html'
})
export class GroupListAdminComponent implements OnInit {

    protected fileName = 'Group';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<GroupDto>();
    ...
    public async edit(dto: GroupDto) {
    ...
    public async view(dto: GroupDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: GroupDto) {
    ...
    public async duplicate(dto: GroupDto) {
    ...
    public exportPdf(dto: GroupDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'changeInterval', header: 'Change interval'},
        ];
    }
	...
	public initDuplicate(res: GroupDto) {
        if (res.members != null) {
             res.members.forEach(d => { d.group = null; d.id = null; });
        }
	}
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                 'Name': e.name ,
                 'Size': e.size ,
                 'Max students': e.maxStudents ,
                 'Change interval': e.changeInterval ,
            }
        });
        ...
        this.criteriaData = [{
            ...
            'Max students Min': this.criteria.maxStudentsMin ? this.criteria.maxStudentsMin : environment.emptyForExport ,
            'Max students Max': this.criteria.maxStudentsMax ? this.criteria.maxStudentsMax : environment.emptyForExport ,
            'Change interval': this.criteria.changeInterval ? this.criteria.changeInterval : environment.emptyForExport ,
        }];
      }
    ...
    get selections(): Array<GroupDto> {
        return this.service.selections;
    }

    set selections(value: Array<GroupDto>) {
