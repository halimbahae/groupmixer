...
// add
    ...
    public async loadGroup(){
        this.groupService.findAll().subscribe(groups => this.groups = groups, error => console.log(error))
    }
   ...
   public prepareColumnExport(): void {
        ...
        this.criteriaData = [{
            ...
            'Role': this.criteria.role ? this.criteria.role : environment.emptyForExport ,
        //'Group': this.criteria.group?.id ? this.criteria.group?.id : environment.emptyForExport ,
