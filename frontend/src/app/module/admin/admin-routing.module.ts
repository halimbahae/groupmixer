            ...
            [
                {
                    ...
                    children: [
                        ...
                        {
                            path: 'member',
                            loadChildren: () => import('./view/member/member-admin-routing.module').then(x => x.MemberAdminRoutingModule),
                            canActivate: [AuthGuard],
                        },
                        {
                            path: 'group',
                            loadChildren: () => import('./view/group/group-admin-routing.module').then(x => x.GroupAdminRoutingModule),
                            canActivate: [AuthGuard],
                        },
                        {
                            path: 'security',
